    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "El plan de Marketing Digital tiene un compromiso mínimo de 3 meses desde su inicio, por el tiempo que necesitan los anuncios y el SEO para dar resultados medibles. Cumplido ese plazo, se cancela de un mes a otro como los demás.",
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "The Digital Marketing plan has a 3-month minimum commitment from its start date, for the time ads and SEO need to produce measurable results. After that, it cancels month to month like the rest.",
