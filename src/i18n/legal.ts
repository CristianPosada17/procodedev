    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "La Auditoría Digital es un pago único de $250 USD por adelantado y NO se acredita al precio de un proyecto posterior: es un servicio independiente, con su propio entregable, y se contrata y se paga por separado.",
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "The Digital Audit is a one-time $250 USD payment made up front and is NOT credited toward the price of a later project: it is a standalone service with its own deliverable, contracted and paid separately.",
